...
namespace StylishWebsiteBE.Data.Migrations
{
    ...
    [Migration("20240324103710_Update_VV")]
    partial class Update_VV
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StylishWebsiteBE.Domain.ReadModels.Identities.ApplicationUserReadModel", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("AccessTokenExpireTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("StylishWebsiteBE.Domain.ReadModels.Products.VariantValueReadModel", b =>
                {
                    ...
                    b.Property<Guid?>("OptionReadModelId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("OptionValueReadModelId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ProductOptionReadModelId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StylishWebsiteBE.Domain.ReadModels.Products.VariantValueReadModel", b =>
                {
                    b.HasOne("StylishWebsiteBE.Domain.ReadModels.Options.OptionReadModel", null)
                        .WithMany("VariantValues")
                        .HasForeignKey("OptionReadModelId");

                    b.HasOne("StylishWebsiteBE.Domain.ReadModels.Options.OptionValueReadModel", null)
                        .WithMany("VariantValues")
                        .HasForeignKey("OptionValueReadModelId");
                    ...
                    b.HasOne("StylishWebsiteBE.Domain.ReadModels.Products.ProductOptionReadModel", null)
                        .WithMany("VariantValues")
                        .HasForeignKey("ProductOptionReadModelId");
