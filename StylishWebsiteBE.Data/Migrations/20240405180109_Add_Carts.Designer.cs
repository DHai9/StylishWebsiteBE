...
namespace StylishWebsiteBE.Data.Migrations
{
    ...
    [Migration("20240405180109_Add_Carts")]
            ...
            modelBuilder.Entity("StylishWebsiteBE.Domain.ReadModels.Cards.CartDetailReadModel", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("CardId"), new[] { "Id", "ProductVariantId", "Quantity" });

                    b.HasIndex("Id")
                        .IsUnique();

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Id"), new[] { "CardId", "ProductVariantId", "Quantity" });
